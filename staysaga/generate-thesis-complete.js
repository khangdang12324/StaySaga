const { Document, Packer, Paragraph, TextRun, Table, TableRow, TableCell, HeadingLevel, AlignmentType, BorderStyle, WidthType, VerticalAlign, convertInchesToTwip, PageBreak, UnderlineType } = require('docx');
const fs = require('fs');
...
function generatePart1() {
  ...
  sections.push(
    ...
    createParagraph('XÂY DỰNG HỆ THỐNG QUẢN LÝ HOMESTAY STAYSAGA', { bold: true, spacing: { after: 120 } }),
    createParagraph('Sinh viên: <HỌ VÀ TÊN> (MSSV: <MSSV>)', { spacing: { after: 120 } }),
    createParagraph('Đã được chấp thuận bởi:', { spacing: { after: 120 } }),
    createParagraph('Giáo viên hướng dẫn: <TÊN GIÁO VIÊN> _______________', { spacing: { after: 180 } }),
    createParagraph('(Ký và ghi rõ họ tên)', { size: 22, spacing: { after: 120 } }),
    createParagraph('Giáo viên phản biện: <TÊN GIÁO VIÊN> _______________', { spacing: { after: 180 } }),
    createParagraph('(Ký và ghi rõ họ tên)', { size: 22, spacing: { after: 120 } }),
    createParagraph('Chủ tịch Hội đồng: <TÊN GIÁO VIÊN> _______________', { spacing: { after: 180 } }),
    createParagraph('(Ký và ghi rõ họ tên)', { size: 22, spacing: { after: 240 } }),
    createParagraph('Thành phố Hồ Chí Minh, ngày ... tháng ... năm 2026', { spacing: { after: 60 } }),
    new PageBreak(),
    ...
    createParagraph('Em <HỌ VÀ TÊN>, sinh viên lớp <LỚP>, khóa <KHÓA> trường Đại học Công nghệ TP. HCM cam kết:'),
    createParagraph('1. Đây là công trình do em tự hoàn thành, không sao chép từ bất kỳ nguồn nào khác.'),
    createParagraph('2. Các tài liệu tham khảo được dẫn chiếu đầy đủ theo quy định.'),
    createParagraph('3. Em chịu trách nhiệm về nội dung và chất lượng của công trình này.'),
    ...
    createParagraph('• Giáo viên hướng dẫn <TÊN GIÁO VIÊN> - đã tận tình hướng dẫn và chỉ bảo trong quá trình thực hiện đồ án.'),
    createParagraph('• Các giáo viên bộ môn - đã cung cấp kiến thức nền tảng cho em.'),
    createParagraph('• Các bạn học khóa - đã giúp đỡ em trong quá trình thực hiện.'),
    createParagraph('Em cũng xin cảm ơn nhà trường và tất cả những người đã tạo điều kiện cho em hoàn thành công trình này.', { spacing: { after: 60 } }),
    new PageBreak(),
    ...
    createParagraph('StaySaga là một hệ thống quản lý homestay hiện đại, được xây dựng bằng công nghệ Next.js 16.2.6 và Supabase. Hệ thống cung cấp các tính năng quản lý bất động sản, đặt phòng, thanh toán, và quản lý người dùng toàn diện.'),
    createParagraph(''),
    ...
    createParagraph('• Bản đồ tương tác: Leaflet, OpenStreetMap, Nominatim API'),
    createParagraph(''),
    createParagraph('Từ khóa: Homestay, Next.js, Supabase, React, Property Management, Web Application', { spacing: { after: 60 } }),
    new PageBreak(),
    ...
    createParagraph('CHƯƠNG 1: TỔNG QUAN VỀ QUẢN LÝ HOMESTAY .......................5'),
    createParagraph('CHƯƠNG 2: CƠ SỞ LÝ THUYẾT VÀ CÔNG NGHỆ .......................15'),
    createParagraph('CHƯƠNG 3: PHÂN TÍCH VÀ THIẾT KẾ YÊU CẦU .......................30'),
    createParagraph('CHƯƠNG 4: THIẾT KẾ HỆ THỐNG .......................45'),
    createParagraph('CHƯƠNG 5: PHÁT TRIỂN VÀ TRIỂN KHAI .......................60'),
    createParagraph('CHƯƠNG 6: DOCKER VÀ DEPLOYMENT .......................80'),
    createParagraph('CHƯƠNG 7: SỬ DỤNG AI TRONG PHÁT TRIỂN .......................92'),
    ...
    createParagraph('1.1. Khái niệm Homestay', { ...HEADING_2_STYLE, spacing: { before: 0, after: 120 } }),
    createParagraph('Homestay là hình thức cho thuê nhà ở ngắn hạn, nơi chủ nhà cho phép du khách thuê một hoặc nhiều phòng trong nhà của họ. Đây là một xu hướng du lịch ngày càng phổ biến trên toàn thế giới.'),
    createParagraph(''),
    ...
    createParagraph('Thị trường homestay Việt Nam tăng trưởng nhanh chóng trong 5 năm qua. Các thành phố du lịch như Đà Lạt, Sapa, Hội An, Nha Trang là những điểm nóng.'),
    createParagraph(''),
    ...
    createParagraph('StaySaga là nền tảng quản lý homestay toàn diện, giải quyết các thách thức trên thông qua:'),
    ...
    createParagraph('2.1. Kiến trúc Web Application hiện đại', { ...HEADING_2_STYLE, spacing: { before: 0, after: 120 } }),
    createParagraph('Các ứng dụng web hiện đại sử dụng mô hình client-server với frontend và backend tách biệt.'),
    createParagraph(''),

    createSectionParagraph('2.2', 'Next.js Framework'),
    createParagraph('Next.js là framework React được xây dựng trên Node.js, cung cấp:'),
    ...
    createParagraph('React là thư viện JavaScript cho phép xây dựng giao diện người dùng với:'),
    ...
    createParagraph('Tailwind CSS là utility-first CSS framework cho phép styling nhanh chóng:'),
    ...
    createParagraph('Supabase là nền tảng backend open-source dựa trên PostgreSQL:'),
    ...
    createParagraph('Docker cho phép đóng gói ứng dụng với tất cả dependencies:'),
...
function generatePart2() {
  ...
  sections.push(
    ...
    createParagraph('3.1. Yêu cầu chức năng', { ...HEADING_2_STYLE, spacing: { before: 0, after: 120 } }),
    ...
    createParagraph('4.1. Kiến trúc hệ thống', { ...HEADING_2_STYLE, spacing: { before: 0, after: 120 } }),
    ...
    createParagraph('5.1. Quá trình phát triển', { ...HEADING_2_STYLE, spacing: { before: 0, after: 120 } }),
    ...
    createParagraph('6.1. Containerization với Docker', { ...HEADING_2_STYLE, spacing: { before: 0, after: 120 } }),
    ...
    createParagraph('7.1. Nhập môn AI trong phát triển', { ...HEADING_2_STYLE, spacing: { before: 0, after: 120 } }),
    createParagraph('AI và machine learning được sử dụng để hỗ trợ quá trình phát triển:'),
    createParagraph(''),
    ...
    createParagraph('8.1. Kết quả đạt được', { ...HEADING_2_STYLE, spacing: { before: 0, after: 120 } }),
    ...
    createParagraph('Dự án StaySaga đã chứng minh khả năng xây dựng một ứng dụng web full-stack hiện đại bằng Next.js, React, và Supabase. Hệ thống cung cấp giải pháp toàn diện cho quản lý homestay với giao diện thân thiện và tính năng mạnh mẽ.'),
    createParagraph(''),
    ...
    createParagraph(''),
    createParagraph('Dự án này cung cấp nền tảng vững chắc cho sự phát triển trong tương lai với khả năng mở rộng quy mô, thêm tính năng mới, và cải thiện hiệu năng.'),
    createParagraph('', { spacing: { after: 300 } }),
    ...
    createParagraph('[1] Next.js Documentation. "Next.js 16 Official Documentation". https://nextjs.org/docs'),
    createParagraph('[2] React Documentation. "React 19 Reference". https://react.dev'),
    createParagraph('[3] Supabase Documentation. "Supabase PostgreSQL Backend". https://supabase.com/docs'),
    createParagraph('[4] Tailwind CSS. "Utility-First CSS Framework". https://tailwindcss.com'),
    createParagraph('[5] TypeScript. "TypeScript Handbook". https://www.typescriptlang.org/docs'),
    createParagraph('[6] Docker. "Docker Documentation". https://docs.docker.com'),
    createParagraph('[7] Leaflet. "Interactive Maps Library". https://leafletjs.com'),
    createParagraph('[8] OpenStreetMap. "Free Wiki World Map". https://www.openstreetmap.org'),
    createParagraph('[9] Nominatim. "Geocoding with OpenStreetMap". https://nominatim.org'),
    createParagraph('[10] MDN Web Docs. "Web Technologies Reference". https://developer.mozilla.org'),
    createParagraph('[11] The Pragmatic Programmer. "Your Journey to Mastery". 2nd Edition'),
    createParagraph('[12] Clean Code. "A Handbook of Agile Software Craftsmanship". Robert C. Martin'),
    createParagraph('[13] Design Patterns. "Elements of Reusable Object-Oriented Software". Gang of Four'),
    createParagraph('[14] Web Security Academy. "OWASP Top 10 Security Risks". https://owasp.org'),
    createParagraph('[15] Vercel. "Next.js Deployment on Vercel". https://vercel.com/docs'),
  );
...
async function createThesisDocuments() {
  try {
    ...
    fs.writeFileSync(
      path.join(__dirname, 'Xay_Dung_He_Thong_Quan_Ly_Homestay_StaySaga_Part1.docx'),
      part1Buffer
    );
    ...
    fs.writeFileSync(
      path.join(__dirname, 'Xay_Dung_He_Thong_Quan_Ly_Homestay_StaySaga_Part2.docx'),
      part2Buffer
    );
