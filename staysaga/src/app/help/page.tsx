  ...
  const faqs = [
    {
      ...
      a: 'Chọn chỗ ở yêu thích, chọn ngày nhận/trả phòng và số khách, sau đó nhấn "Đặt phòng ngay" và hoàn tất thanh toán.',
    },
    {
      q: "Chính sách hủy phòng như thế nào?",
      a: "Mỗi chỗ ở có chính sách hủy riêng. Bạn có thể xem chi tiết tại trang thông tin của chỗ ở trước khi đặt phòng.",
    },
    {
      q: "Tôi có thể thay đổi ngày đặt phòng không?",
      a: "Bạn có thể liên hệ chủ nhà hoặc bộ phận hỗ trợ để thay đổi ngày. Tùy thuộc vào tình trạng phòng trống.",
    },
    {
      q: "Phương thức thanh toán nào được chấp nhận?",
      a: "StaySaga hỗ trợ thanh toán qua Thẻ tín dụng/ghi nợ (Visa, Mastercard), VNPay, MoMo và chuyển khoản ngân hàng.",
    },
    {
      q: "Làm sao để trở thành Host (Chủ nhà)?",
      a: 'Đăng nhập vào tài khoản, vào mục "Quản lý chỗ ở" trong menu và nhấn "Đăng chỗ ở mới".',
    },
  ];
      ...
      <div className="pt-28 pb-20 max-w-3xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-shadow cursor-pointer">
            ...
            <h3 className="font-bold text-gray-900 mb-1">Gửi email</h3>
