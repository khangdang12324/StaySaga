...
export default async function BookingSuccessPage(props: {
  ...
  const userEmail =
    session?.user?.email || "hdnx8m9jmp@privaterelay.appleid.com";
  ...
  const city =
    booking?.homestay?.city || booking?.homestay?.location || "Đà Lạt";
  ...
  const displayCode = bookingId
    ? bookingId.toString().slice(-10).replace(/\D/g, "").padEnd(10, "0")
    : "6884160358";
  const pinCode = "7142";
  const mainImage =
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold mb-4">
                {t("Đặt phòng của bạn ở", "Your booking in")} {city}{" "}
                {t("đã được xác nhận.", "is confirmed.")}
              </h1>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-start gap-2 text-sm">
                  ...
                  <p>
                    {t(
                      ...
                      "All set! We sent a confirmation email to",
                    )}{" "}
                ...
                <div className="flex items-start gap-2 text-sm">
                  ...
                  <p>
                    ...
                    {t("của bạn sẽ được xử lý bởi", "will be handled by")}{" "}
                    {hotelName}.{" "}
                    {t(
                      'Mục "Giá" dưới đây sẽ cung cấp thêm chi tiết cho bạn',
                      'See the "Price" section below for details.',
                    )}
                  </p>
                </div>
                <div className="flex items-start gap-2 text-sm">
                  ...
                  <p>
                    <a href="#" className="text-rose-600 hover:underline">
                      {t("Tải ứng dụng", "Download the app")}
                    </a>{" "}
                    {t(
                      "để lưu bản xác nhận điện tử",
                      "to save your e-confirmation",
                    )}
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white border border-zinc-200 rounded p-4 flex items-start gap-4 shadow-sm">
              ...
              <div>
                <h3 className="font-bold text-sm mb-1">
                  {t("Luôn an toàn online", "Stay safe online")}
                </h3>
                <p className="text-[13px] text-zinc-600 mb-2">
                  {t(
                    "Vui lòng xem chính sách thanh toán của bạn. StaySaga tuyệt đối không yêu cầu bạn cung cấp thông tin tài khoản hoặc thông tin thanh toán qua điện thoại, email hay dịch vụ chat. Nếu bạn có điều gì nghi ngờ, vui lòng báo cho chúng tôi.",
                    "Please review your payment policy. StaySaga will never ask you to provide account or payment information over phone, email or chat. If you have any doubts, please report to us.",
                  )}
                </p>
                <a
                  href="#"
                  className="text-rose-600 text-[13px] hover:underline"
                >
            ...
            <div>
              <h2 className="text-xl font-bold mb-4">
                {t("Tóm tắt đơn đặt", "Booking Summary")}
              </h2>
                ...
                <div className="p-4 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <div className="flex items-center gap-2 text-[13px] text-zinc-600 mb-1">
                      ...
                      {format(startDate, "EEE, dd")} {t("tháng", "th")}{" "}
                      {format(startDate, "MM, yyyy")} -{" "}
                      {format(endDate, "EEE, dd")} {t("tháng", "th")}{" "}
                      {format(endDate, "MM, yyyy")} , {nights}{" "}
                      {t("đêm", "nights")}
                    </div>
                  ...
                  <div className="mt-4 flex justify-end">
                    <Link
                      ...
                      className="bg-rose-600 hover:bg-rose-700 text-white font-bold px-4 py-2 rounded text-sm transition-all"
                    >
                      {t(
            ...
            <div className="bg-white border border-zinc-200 rounded p-6 shadow-sm mt-6">
              <h2 className="text-xl font-bold mb-1 text-zinc-900">
                {t("Liên hệ với chỗ nghỉ", "Contact the property")}
              </h2>
              <p className="text-sm text-zinc-550 mb-6">
                {t(
                  "Bạn có thắc mắc hoặc cần thu xếp một số thứ cho kỳ nghỉ?",
                  "Have a question or need to arrange something for your stay?",
                )}
              </p>
              <div className="space-y-6">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-zinc-900">
                      {t("Gửi email cho chỗ nghỉ", "Email the property")}
                    </h4>
                    <p className="text-[13px] text-zinc-600 mb-1 leading-normal">
                      {t(
                        "Hãy email cho chỗ nghỉ và họ sẽ trả lời sớm nhất có thể",
                        "Email the property and they will respond as soon as possible",
                      )}
                    </p>
                    <a
                      href={`mailto:${booking?.homestay?.owner?.email || "owner@staysaga.com"}`}
                      className="text-rose-600 hover:underline font-semibold text-sm"
                    >
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-zinc-900">
                      {t("Lựa chọn khác", "Other options")}
                    </h4>
                    <a
                      href={`tel:${booking?.homestay?.owner?.phone || "+842836225811"}`}
                      className="text-rose-600 hover:underline font-semibold text-sm"
                    >
                      {t("Gọi điện", "Call")}{" "}
                      {booking?.homestay?.owner?.phone || "+842836225811"}
                    </a>
                  </div>
                </div>
              </div>
            ...
            <section
              id="booking-details"
              className="scroll-mt-8 space-y-8 border-t border-zinc-200 pt-8"
            >
              <div>
                <h2 className="text-2xl font-bold text-rose-600 mb-4">
                  {hotelName}
                  <span className="ml-2 text-amber-400 text-base">★★★</span>
                  <span className="ml-2 rounded bg-rose-600 px-2 py-1 text-sm text-white">
                    Genius
                  </span>
                </h2>
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="border-r border-zinc-200 pr-6">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <a
                              href="#"
                              className="mt-2 inline-block font-bold text-rose-600 hover:underline"
                            >
                              Thay đổi ngày tháng
                            </a>
                          </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p>
                          {booking?.guests || 2} người lớn - {nights} đêm, 1
                          Phòng
                        </p>
                        <a
                          href="#"
                        ...
                        >
                          Thêm lựa chọn chỗ nghỉ cho khách
                        </a>
                      </div>
                      <div>
              ...
              <div>
                ...
                <dl className="grid grid-cols-1 gap-x-8 gap-y-5 text-[15px] sm:grid-cols-[220px_1fr]">
                  ...
                  <dd>
                    {session?.user?.user_metadata?.full_name || userEmail}{" "}
                    <a
                      href="#"
                      className="ml-3 font-bold text-rose-600 hover:underline"
                    >
                      Thay đổi tên khách
                    </a>
                  </dd>
                  ...
                  <dd>
                    Phòng tắm riêng, đồ vệ sinh cá nhân miễn phí, vòi sen, điều
                    hòa không khí, bàn làm việc, TV màn hình phẳng, máy sấy tóc,
                    khăn tắm, tủ hoặc phòng để quần áo, khu vực phòng ăn.
                  </dd>
                  <dt className="font-bold">Trẻ em và giường</dt>
                  <dd>
                    <span className="font-bold">Chính sách trẻ em</span>
                    <br />
                    Phù hợp cho tất cả trẻ em.
                    <br />
                    <br />
                    <span className="font-bold">
                      Chính sách nôi và giường phụ
                    </span>
                    <br />
                  ...
                  <dd>
                    ...
                    <br />
                    từ {format(startDate, "dd MMM yyyy HH:mm")}: VND 0<br />
                    <span className="mt-2 block text-sm text-zinc-600">
                      Thời hạn hủy được tính theo giờ địa phương của chỗ nghỉ.
                    </span>
                  </dd>
                </dl>
              </div>
              ...
              <div className="overflow-hidden rounded border border-rose-100 bg-white">
                <div className="flex justify-between p-5">
                  ...
                  <span className="text-right">
                    VND {(Number(totalPrice) * 0.91).toLocaleString("vi-VN")}
                    <br />
                    VND {(Number(totalPrice) * 0.09).toLocaleString("vi-VN")}
                  </span>
                </div>
                <div className="flex justify-between border-t border-rose-100 bg-rose-50 p-5">
                  <span className="text-xl text-rose-700">
                    ...
                    <span className="text-sm text-zinc-700">
                      (dành cho {booking?.guests || 2} khách)
                    </span>
                  </span>
                ...
                <div className="space-y-4 border-t border-rose-100 p-5 text-[15px]">
                  <p>
                    ...
                    <br />
                    StaySaga không thu phí khách cho bất kỳ đặt phòng, phí hành
                    chính hay bất kỳ chi phí nào khác.
                  </p>
                  <p>
                    <span className="font-bold">Thông tin thanh toán</span>
                    <br />
                    {hotelName} xử lý tất cả thanh toán. Chỗ nghỉ này chấp nhận
                    Visa, Mastercard hoặc thanh toán khi đến theo chính sách chỗ
                    nghỉ.
                  </p>
                  <p>
                    <span className="font-bold">Thông tin bổ sung</span>
                    <br />
                    Các khoản phí phụ thu không được tính trong giá tổng cộng
                    này. Nếu bạn hủy hoặc không đến nhận phòng, chỗ nghỉ vẫn có
                    thể thu phí theo quy định.
                  </p>
                </div>
              </div>
                  ...
                  <div className="border-b border-zinc-200 md:border-b-0 md:border-r">
                    {[
                      ...
                      <div
                        ...
                        className={
                          index === 0
                            ? "border-b-2 border-rose-600 p-4 font-bold text-rose-600"
                            : "p-4 font-bold"
                        }
                      >
                        {item}
                      ...
                      >
                        ...
                        {index === 0 && (
                          <p className="mt-4 text-zinc-700">
                            Có. Phí hủy đặt phòng được quyết định bởi chỗ nghỉ
                            và hiển thị trong chính sách hủy đặt phòng của bạn.
                          </p>
                        )}
                      </details>
                    ))}
              ...
              <div className="border-t border-zinc-200 pt-6">
                ...
                <div className="grid gap-10 sm:grid-cols-2">
                  <div className="space-y-3">
                    ...
                    <a
                      href="#"
                      className="block font-bold text-rose-600 hover:underline"
                    >
                      Thay đổi ngày tháng
                    </a>
                    <a
          ...
          <div className="mt-6 space-y-4 lg:sticky lg:top-6 lg:self-start lg:mt-0">
            ...
            <div className="rounded border border-green-600 bg-green-50 p-4 shadow-sm">
              <div className="flex justify-between items-center mb-2">
                <span className="text-[13px] font-bold text-zinc-700">
                  {t("Mã xác nhận:", "Confirmation number:")}
                </span>
                <span className="text-[15px] font-bold flex items-center gap-2">
                  {displayCode}{" "}
                  <Copy className="w-4 h-4 text-rose-600 cursor-pointer" />
                </span>
              </div>
              ...
              <ul className="space-y-2 mb-4 text-[13px] text-zinc-700 relative z-10">
                <li className="flex items-center gap-2">
                  ...
                  {t(
                    ...
                    "Edit bookings on the go",
                  )}
                </li>
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-green-600" />{" "}
                  {t("Xem xác nhận ngoại tuyến", "View confirmation offline")}
                </li>
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-green-600" />{" "}
                  {t(
                    "Nhắn tin cho chỗ nghỉ bất kỳ lúc nào",
            ...
            <div className="overflow-hidden rounded border border-rose-100 bg-rose-50 shadow-sm">
              <div className="space-y-4 p-5">
                ...
                <Link
                  href={`/bookings/${bookingId}`}
                  className="flex items-center gap-3 font-bold text-rose-600 hover:underline"
                >
                  <X className="h-4 w-4" /> Hủy đặt phòng
                </Link>
                <Link
                  href={`/bookings/${bookingId}`}
                  className="flex items-center gap-3 font-bold text-rose-600 hover:underline"
                >
                  <Calendar className="h-4 w-4" /> Thay đổi ngày tháng
                </Link>
                <Link
                  href={`/bookings/${bookingId}`}
                  className="flex items-center gap-3 font-bold text-rose-600 hover:underline"
                >
                  <MoreHorizontal className="h-4 w-4" /> Hiển thị tất cả hành
                  động
                </Link>
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  <h3 className="font-bold text-[15px] mb-1">
                    {t(
                      "Bạn đã mở khóa ưu đãi nhờ đặt với chúng tôi",
                      "You unlocked a deal by booking with us",
                    )}
                  </h3>
                  <div className="mt-4 p-3 border border-zinc-200 rounded flex gap-3 cursor-pointer hover:bg-zinc-50 transition-all">
                    <div className="w-10 h-10 bg-rose-600 rounded flex items-center justify-center shrink-0 font-bold text-white text-[10px]">
                      TAXI
                    </div>
                    <div>
                      <p className="font-bold text-[13px] leading-tight text-rose-600">
                        {t(
                          "Đặt taxi sân bay riêng",
                          "Book private airport taxi",
                        )}
                      </p>
                      <span className="bg-[#008009] text-white text-[10px] font-bold px-1 rounded inline-block mt-1">
                        -10% {t("Ưu đãi", "Deal")}
                      </span>
                      <p className="text-[11px] text-[#008009] font-bold mt-1">
                        {t(
                      ...
                      <p className="text-[11px] text-zinc-500 mt-1">
                        {t("Giá một chiều từ", "One-way from")}{" "}
                        <span className="text-[#bf0000]">
                          {formatCurrency(592090)}
                        </span>{" "}
                        <span className="line-through">
                          {formatCurrency(657877)}
                        </span>
                      </p>
                    </div>
                  </div>
